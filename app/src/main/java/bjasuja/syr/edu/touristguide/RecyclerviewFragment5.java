...
public class RecyclerviewFragment5 extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View v = inflater.inflate(R.layout.fragment_recyclerview_fragment5, container, false);

        recyclerView = (RecyclerView) v.findViewById(R.id.recycler_view5);
        ...
        if(movieList.isEmpty()) {
            new JSONP().execute(ViewPagerFragment.s5);
        }
