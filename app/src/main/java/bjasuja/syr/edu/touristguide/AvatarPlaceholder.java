...
public class AvatarPlaceholder extends Drawable {
    public static final String DEFAULT_PLACEHOLDER_STRING = "TG";
    private static final String DEFAULT_PLACEHOLDER_COLOR = "#98cc0000";
    private static final String COLOR_FORMAT = "#FFCC0000";
    public static final int DEFAULT_TEXT_SIZE_PERCENTAGE = 45;
