...
public class RecyclerviewFragment4 extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View v = inflater.inflate(R.layout.fragment_recyclerview_fragment4, container, false);

        recyclerView = (RecyclerView) v.findViewById(R.id.recycler_view4);
        ...
        if(movieList.isEmpty()) {
            new JSONP().execute(ViewPagerFragment.s4);
        }
