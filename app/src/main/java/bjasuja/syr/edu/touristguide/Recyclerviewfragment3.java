...
public class Recyclerviewfragment3 extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View v = inflater.inflate(R.layout.fragment_recyclerviewfragment3, container, false);
        ...
        if(movieList.isEmpty()) {
            new JSONP().execute(ViewPagerFragment.s3);
        }
            ...
            try {
                ...
                for(int i=0; i < jsonArray.length(); i++)
                {
                    ...
                    if(openinghours!=null) {
                        opennow = openinghours.optString("open_now").toString();
                    }
