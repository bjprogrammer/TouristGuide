...
public class RecyclerviewFragment7 extends Fragment {
    static List<Movie> movieList = new ArrayList<>();
    private RecyclerView recyclerView;
    static  MovieAdapter mAdapter;
    static Boolean mShowingBack = false;

    public RecyclerviewFragment7() {
    }
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View v = inflater.inflate(R.layout.fragment_recyclerview_fragment7, container, false);

        recyclerView = (RecyclerView) v.findViewById(R.id.recycler_view7);
        ...
        if(movieList.isEmpty()) {
            new JSONP().execute(ViewPagerFragment.s7);
        }
