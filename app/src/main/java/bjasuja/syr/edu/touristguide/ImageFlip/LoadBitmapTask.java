 ...
 */
package bjasuja.syr.edu.touristguide.ImageFlip;
...
import bjasuja.syr.edu.touristguide.R;
...
public final class LoadBitmapTask implements Runnable {
    ...
    private LoadBitmapTask(Context context) {
        ...
        mPortraitBGs = new int[][] {
            new int[] {R.drawable.pic1, R.drawable.pic2, R.drawable.pic3,
